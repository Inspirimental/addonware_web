...
-- Create policies for employees table (admin access required for management)
...
CREATE POLICY "Employees can update their own profile" ON public.employees
  ...
  WITH CHECK (
    -- Employees cannot change their email or name
...
-- Create policies for case_studies table (admin access required)
